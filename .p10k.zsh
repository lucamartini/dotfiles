# Generated by Powerlevel10k configuration wizard on 2024-03-15 at 12:50 CET.
...
# round separators, sharp heads, flat tails, 2 lines, solid, no frame,
...
() {
  ...
  ################[ pyenv: python environment (https://github.com/pyenv/pyenv) ]################
  # Pyenv color.
  typeset -g POWERLEVEL9K_PYENV_FOREGROUND=18
