...
SYNTAX_THEME=$ZSH_DIR/zsh-syntax-highlighting-colorschemes/tokyonight-storm.zsh
source "$SYNTAX_THEME"
...
[[ ! -f "$ZSH_DIR/p10k-colorschemes/tokyonight-storm.zsh" ]] || source "$ZSH_DIR/p10k-colorschemes/tokyonight-storm.zsh"
